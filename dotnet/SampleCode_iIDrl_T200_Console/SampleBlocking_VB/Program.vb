...
Module Program
    ...
    Sub Main(args As String())
        ...
        If docIntControl IsNot Nothing Then
            ...
            Console.WriteLine("")
            While Console_ExecuteAndContinueAsync(docIntControl)
                Thread.Sleep(500)
            End While
    ...
    Private Function Console_ExecuteAndContinueAsync(docIntControl As DocInterfaceControl) As Boolean
        'Main Console MENU
        Console.WriteLine("")
        Console.WriteLine("--------------------")
        ...
        If docIntControl IsNot Nothing Then
            If docIntControl.IsInitialized Then
                Try
                    ...
                    Dim getSensorResult = docIntControl.GetSensorData(&HFC) ' FC = scan all TELID® types
                    Dim processSpan As TimeSpan = Date.UtcNow - startTime
